  ...
  return (
    <div className="flex flex-col justify-center items-center mt-2 relativepx-2 py-2 " id='about'>
        ...
        <div className='flex justify-center items-center h-full gap-12 flex-col md:flex-row relative  group'>
            <img src={ YashWardhan } alt="Yashwardhan" width={300} className='rounded-3xl shadow-2xl filter grayscale group-hover:grayscale-0 group-hover:scale-110 duration-300 ease-in group-hover:rotate-6'/>
