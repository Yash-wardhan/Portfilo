...
function Home() {
  return (
    <div className='h-[80vh] flex flex-col justify-center items-center md:items-end py-20 px-4' id="Home">
            <div className='h-screen md:gap-5 px-4 grid md:grid-cols-5 justify-center items-center'>
                ...
                <div className='md:col-span-2 flex justify-center mt-4'>
                    <img src={ YashWardhan } className='shadow-lg rounded-full max-w-full h-auto align-middle border-gray-600 hover:shadow-2xl hover:scale-110 cursor-pointer ease-in-out transition duration-300  w-[300px] hover:rotate-6'/>
                </div>
            </div>
    </div>
  )
